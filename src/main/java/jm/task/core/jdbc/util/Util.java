...
public class Util {
    ...
    private static void loadDriver() {
        try {
            Class.forName("org.postgresql.Driver");//загрузка класса драйвера в память JVM (metaspace память).Таким образом не будет исключения у DriverManager даже если работаем до java 1.8 */
